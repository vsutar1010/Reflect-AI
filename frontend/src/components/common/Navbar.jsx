          ...
          {user ? (
            <>
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-sm font-semibold bg-white/5 hover:bg-white/10 border border-white/10 text-slate-200 hover:text-white px-4 py-2 rounded-full transition-all duration-300"
              >
          ...
          <div className="flex flex-col gap-2 pt-2 border-t border-white/5">
            {user ? (
              <>
                ...
                <button
                  onClick={handleLogout}
                  className="flex items-center justify-center gap-1.5 text-sm text-center font-semibold bg-white/5 border border-white/10 text-slate-200 py-2.5 rounded-full transition-all duration-300"
                >
              ...
              <>
                <Link to="/login" className="text-sm text-center font-medium text-slate-300 hover:text-white py-2 transition-colors" onClick={() => setIsOpen(false)}>
                  Login
                </Link>
                <Link
                  to="/signup"
